   ...
   output reg  [1:0]    B
    ...
    always @(posedge clk) begin
        if (!video_active) begin
            ...
            R <= bitmap_r | count_r | rail_r | text_r | peg_r | bar_r | full_r;
            G <= bitmap_g | count_g | rail_g | text_g | peg_g | bar_g | full_g;
            B <= bitmap_b | count_b | rail_b | text_b | peg_b | bar_b | full_b;
        end
    end
